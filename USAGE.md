...
The easiest way to use this extension is to download tinyxml2ex.h and save it to the same folder as tinyxml2. In your code, include the header for tinyxml2ex which includes tinyxml2.h in turn. Remember to put the folder on your include path.
```#include <tixml2ex.h>```
